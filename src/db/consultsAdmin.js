...
const createPackage = async (idPackage, idHotels, idRestaurant, idAttraction, idAttraction2, pricePackage) => {
    try {
      const query = `
      ...
      const values = [idPackage, idHotels, idRestaurant, idAttraction, idAttraction2, pricePackage];
...
export const consults = { getAllusers, createPackage }
